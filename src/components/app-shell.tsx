        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
              ...
              {/* Domain badge — shows the auto-detected domain (Sales/Marketing/HR/etc.) */}
              {domainTemplate && DomainIcon && (
                <Badge
                  variant="outline"
                  className="text-[9px] h-4 px-1 uppercase tracking-wide text-primary border-primary/40 bg-primary/8 gap-0.5"
                  title={`Detected domain: ${domainTemplate.label} — ${domainTemplate.description}`}
                >
                  <DomainIcon className="h-2.5 w-2.5" />
                  {domainTemplate.label}
                </Badge>
              )}
            </div>
          </div>
